...
export const FLOWER_CATALOGUE: FlowerCategory[] = [
  {
    ...
    items: [
      ...
      { name: 'Peach & Cream Roses', image: '/flowers/peach-cream-roses.webp' },
      { name: 'Pink Spray Roses', image: '/flowers/pink-spray-roses.webp' },
      { name: 'Blush Pink Roses', image: '/flowers/blush-pink-roses.webp' },
      { name: 'Magenta Roses', image: '/flowers/magenta-roses.webp' },
    ],
  },
  {
    category: 'Carnations',
    items: [
      ...
      { name: 'Magenta Spray Carnations', image: '/flowers/magenta-spray-carnations.webp' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Magenta Dendrobium Orchid', image: '/flowers/magenta-dendrobium-orchid.webp' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Purple Lisianthus', image: '/flowers/purple-lisianthus.webp' },
